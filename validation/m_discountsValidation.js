...
exports.findFilterKeys = joi.object({
  ...
  ...Object.fromEntries(
    keys.map(key => [key, joi.object({
      ...
      is_active: joi.alternatives().try(joi.array().items(),joi.boolean(),joi.object()),
      value: joi.alternatives().try(joi.array().items(),joi.number(),joi.object()),
      is_percent: joi.alternatives().try(joi.array().items(),joi.boolean(),joi.object()),
