...
/**
 * makeUniqueValidation: check unique validation while user registration
 * @param {function} userService  : service of user model
 * @return {boolean} flag : validation status
 */
 ...
 * @param  {obj} model : sequelize model instance
 * @param  {function} userRoleService : user role db service
 * @param  {function} routeRoleService : route role db service
 * @param  {int} userId : id of user to find role data
 * @return {obj} : user's role access for APIs of model
 */
async function getRoleAccessData (model,userRoleService,routeRoleService,userId) {
